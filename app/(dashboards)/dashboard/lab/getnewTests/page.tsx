...
export default function CustomerTestPage() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        setCustomers(data.data); // Adjust this if Strapi returns a different format
  ...
  // Fetch test data for a selected customer
  const fetchTestData = async (customerId: number) => {
    ...
    try {
      ...
      const data = await response.json();
      setTestData(data.data); // Adjust this if Strapi returns a different format
    } catch (err) {
          ...
          {filteredCustomers.map((customer) => (
            <li
              ...
              onClick={() => {
                ...
                fetchTestData(customer.id); // Fetch test data when a customer is selected
              }}
